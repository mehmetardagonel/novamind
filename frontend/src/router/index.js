...
const routes = [
  ...
  },
  {
    ...
    name: "SignUp",
    component: () =>
      import(/* webpackChunkName: "signup" */ "../components/SignUpScreen.vue"),
  },
  {
  ...
  // --- /app layout with children ---
  {
    ...
    name: "AppLayout",
    component: () =>
      import(/* webpackChunkName: "main" */ "../components/MainApp.vue"),
    children: [
      // 1. Inbox
      {
        path: "email/inbox",
        name: "EmailInbox",
        component: () =>
          import(/* webpackChunkName: "email-view" */ "../views/EmailView.vue"),
        props: { folder: "inbox" },
      },
      // 2. Sent
      {
        ...
        name: "EmailSent",
        component: () =>
          import(/* webpackChunkName: "email-view" */ "../views/SentView.vue"),
        props: true,
      },
      // 3. Favorites
      {
        ...
        component: () =>
          import(
            /* webpackChunkName: "email-view" */ "../views/FavoritesView.vue"
          ),
        props: true,
      },
      // Important
      {
        ...
        component: () =>
          import(
            /* webpackChunkName: "email-view" */ "../views/ImportantView.vue"
          ),
        props: true,
      },
      // Spam
      {
        ...
        name: "EmailSpam",
        component: () =>
          import(/* webpackChunkName: "email-view" */ "../views/SpamView.vue"),
        props: true,
      },
      // Drafts
      {
        ...
        component: () =>
          import(
            /* webpackChunkName: "email-view" */ "../views/DraftsView.vue"
          ),
        props: true,
      },
      // Trash
      {
        ...
        name: "EmailTrash",
        component: () =>
          import(/* webpackChunkName: "email-view" */ "../views/TrashView.vue"),
        props: true,
      },
      // Labels
      {
        ...
        component: () =>
          import(
            /* webpackChunkName: "email-view" */ "../views/LabelsView.vue"
          ),
        props: true,
      },
      // AI Assistant
      {
        ...
        component: () =>
          import(
            /* webpackChunkName: "assistant-view" */ "../views/ComposeView.vue"
          ),
      },
      // Compose
      {
        ...
        component: () =>
          import(
            /* webpackChunkName: "compose-email" */ "../views/ComposeEmailView.vue"
          ),
      },
      // Accounts Management
      {
        ...
        component: () =>
          import(
            /* webpackChunkName: "accounts-view" */ "../views/AccountsView.vue"
          ),
      },
...
router.beforeEach(async (to, from, next) => {
  ...
  if (to.path === "/") {
    return next(isAuthed ? "/app/email/inbox" : "/login");
  }

  // If user is logged in and goes to /home, send them to inbox
  if (to.path === "/home" && isAuthed) {
